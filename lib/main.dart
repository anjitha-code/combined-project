...
import 'package:splash_screen/dailyChallenges.dart';
import 'dart:ui';
import 'button.dart';
import 'package:splash_screen/signup.dart';
import 'login.dart';
import 'choose_domain.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/home': (context) => ChooseDomain(
              onNavigateHome: () {
                Navigator.pushNamed(context, '/event');
              },
            ),
        // '/quiz': (context) => QuizPage(),
        '/event': (context) => const DailyChallenge(),
